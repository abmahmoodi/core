...
Rails.application.config.sorcery.submodules = [:activity_logging, :remember_me, :user_activation, :reset_password ]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    # Default: `nil`
    #
    user.user_activation_mailer = Rw::UserMailer
    ...
    # Default: `nil`
    #
    user.reset_password_mailer = Rw::UserMailer
